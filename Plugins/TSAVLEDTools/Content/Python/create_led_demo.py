...
VIDEO_MATERIAL = f"{MATERIAL_PATH}/M_TSAV_LEDVideo"
FRAME_MATERIAL = f"{MATERIAL_PATH}/M_TSAV_LEDFrame"
LEVEL_PATH = "/Game/TSAV/Levels/LED_NDI_Builder"
...
def _build_level(video_material, frame_material):
...
def main():
    ...
    _build_level(video_material, frame_material)
